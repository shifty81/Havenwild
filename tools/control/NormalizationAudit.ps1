...
"- Registry/profile resolution: $listStatus", "- Source validators: $sourceCount / expected 10", "- Build validators: $buildCount / expected 2", "- Framework validators: $frameworkCount / expected 4", "- Python bytecode/cache files: $($bytecode.Count)", '', '## Findings','')
