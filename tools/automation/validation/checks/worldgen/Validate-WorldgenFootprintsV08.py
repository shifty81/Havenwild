...
check(
    ...
    'WORLDGEN_PACK_PATH: &str = "content/worldgen/packs/worldgen_home_island_v0_8.json"' in game
    or 'WORLDGEN_PACK_PATH: &str = "content/worldgen/packs/worldgen_home_island_v0_8.json"' in game,
)
...
(logs / 'worldgen_footprint_validation_v0_8_report.json').write_text(json.dumps(report, indent=2))
