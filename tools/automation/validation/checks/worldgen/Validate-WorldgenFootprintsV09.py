...
check(
    'rust-game:WORLDGEN_PACK_PATH-v0-9-or-newer',
    'WORLDGEN_PACK_PATH: &str = "content/worldgen/packs/worldgen_home_island_v0_9.json"' in game
    or 'WORLDGEN_PACK_PATH: &str = "content/worldgen/packs/worldgen_home_island_v0_9.json"' in game,
)
...
(logs / 'worldgen_footprint_validation_v0_9_report.json').write_text(json.dumps(report, indent=2))
