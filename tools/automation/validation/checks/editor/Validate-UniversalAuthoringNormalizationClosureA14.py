...
require('(EditorViewportMode::SceneMap, "Game Canvas")' in top_bar, "global studio strip lacks the single Game Canvas tab")
...
require('const WIDTHS: [f32; 6]' in ui_shell, "global workspace strip is not normalized to six top-level studios")
